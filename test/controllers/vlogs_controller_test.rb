...
class VlogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vlog" do
    assert_difference('Vlog.count') do
      post vlogs_url, params: { vlog: { desc: @vlog.desc, link: @vlog.link, title: @vlog.title } }
    end
  ...
  test "should update vlog" do
    patch vlog_url(@vlog), params: { vlog: { desc: @vlog.desc, link: @vlog.link, title: @vlog.title } }
